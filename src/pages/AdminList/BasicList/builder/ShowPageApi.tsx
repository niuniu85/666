...
export async function reRequestState(body: BasicListApi.DataSource, c_id?: string) {
  ...
  body.remarks = body.remarks
    ? body.remarks + '|第' + body.call_count + '次|' + body.newRemarks
    : '|第' + body.call_count + '次' + body.newRemarks;
